 ...
 */
final class Version20230321095909 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE topic ADD creator_id INT NOT NULL, ADD views INT NOT NULL, ADD content LONGTEXT DEFAULT NULL, DROP topic_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE topic ADD topic_id INT DEFAULT NULL, DROP creator_id, DROP views, DROP content');
        $this->addSql('ALTER TABLE topic ADD CONSTRAINT FK_9D40DE1B1F55203D FOREIGN KEY (topic_id) REFERENCES topic (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
